...
export default function LogoutModal({ isOpen, closeModal }: { isOpen: boolean; closeModal: () => void }) {
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto bg-white/5 backdrop-blur-sm">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              ...
              <p className="mt-2 text-base text-gray-700">Are you sure you want to log out? Any unsaved changes may be lost.</p>
