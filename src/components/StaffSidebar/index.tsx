...
import { Bell02Icon, ChevronRightIcon, CoinsHandIcon, Dataflow04Icon, File03Icon, HomeLineIcon, LogOut01Icon, Mail01Icon, RefreshCCW04Icon, Settings02Icon, User01Icon, Users01Icon } from "../Icons";
...
export default function StaffSidebar() {
  ...
  return (
    <aside className={`flex h-screen flex-col border-r border-gray-200 bg-white p-4 shadow-2xl ${open ? "w-[300px] max-w-[300px] min-w-[300px]" : ""}`}>
      <div>
        <img
      ...
      <ul className="mt-4 flex flex-grow flex-col gap-1">
        ...
        <MenuItems className="absolute top-0 -right-full w-56 origin-top-right -translate-y-4 divide-y divide-gray-100 rounded-md border border-gray-200 bg-white shadow-lg focus:outline-none">
          <div className="px-1 py-1">
            <MenuItem>
              {({ focus }) => (
                <button
                  className={`group flex w-full cursor-pointer items-center rounded-md px-3 py-3 text-sm ${focus ? "bg-gray-100" : ""}`}
