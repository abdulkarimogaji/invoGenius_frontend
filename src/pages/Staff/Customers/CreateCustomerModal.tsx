...
export default function CreateCustomerModal({ isOpen, closeModal }: { isOpen: boolean; closeModal: () => void }) {
              ...
              <Fieldset>
                <Field className={"mt-4"}>
                  ...
                  <Input
                    ...
                    {...register("first_name")}
                  />
                  <p className="text-xs text-red-600 empty:hidden">{errors.first_name?.message}</p>
                </Field>
                ...
                <Field className={"mt-4"}>
                  ...
                  <Input
                    ...
                    {...register("last_name")}
                  />
                  <p className="text-xs text-red-600 empty:hidden">{errors.last_name?.message}</p>
                </Field>
                ...
                <Field className={"mt-4"}>
                  ...
                  <Input
                    ...
                    {...register("phone")}
                  />
                  <p className="text-xs text-red-600 empty:hidden">{errors.phone?.message}</p>
                </Field>
